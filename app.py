...
DRUG_CLASSES = {
    ...
    "vemurafenib":"BRAFi","encorafenib":"BRAFi","binimetinib":"MEKi",    "palbociclib":"CDK4/6i","ribociclib":"CDK4/6i","abemaciclib":"CDK4/6i","temsirolimus":"mTORi",
...
st.markdown('<div class="main-header">💊 MedCheck AI V4</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-header">Polypharmacy Intelligence Platform | FDA openFDA + Clinical Rule Engine</div>', unsafe_allow_html=True)
...
# =========================================================
st.markdown("---")
st.caption(f"MedCheck AI {APP_VERSION} | U.S. FDA openFDA data | Evidence-Based Educational Prototype | Not Medical Advice | Built for clinical education and research")
